      ...
      <div v-for="(image, index) in mainStore.drawings" :key="index" class="relative">
        ...
        <transition name="fade" mode="out-in">
          <div v-if="markready" class="absolute z-40 w-full">
            ...
            <div class="bg-green-500 opacity-90 px-4 py-2 w-full active:bg-green-600 flex items-center justify-center h-20">
              
              <div v-if="image.uuid === sendDrawing" class="">
              ...
              <button v-else @click="completeDraw(image.uuid)" class="w-full h-full">
                <div class="">
